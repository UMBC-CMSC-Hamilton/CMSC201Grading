...
MAJOR_EXT = "_MAJORS"
NONMAJOR_TAS = ["jazlyni1", "shender2"] # Allows grouping of work to separate majors/nonmajors
sections = "All"
ta_user_id = ""
...
if(len(sys.argv) != 4):
    print("Wrong number of arguments! Usage: ./setup_grading.py <assignment> <--majors | --nonmajors | --all> <ta_user_id>")
    exit()
else:
    ta_user_id = sys.argv[3]
