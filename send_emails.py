...
# MAJORS INSTRUCTORS
INSTRUCTORS = ["kchen6", "allgood1", "eric8", "slupoli"]
# NONMAJORS INSTRUCTORS
#INSTRUCTORS = ["kchen6", "arsenaul"]
...
def send_instructor_emails():
    for instructor in INSTRUCTORS:
        ...
        try:
            #SMTP_SERVER.sendmail("kchen6@umbc.edu", [instructor_email_address], final_instructor.as_string())
...
def send_ta_emails():
    for ta in section_dict:
        ...
        try:
            #SMTP_SERVER.sendmail("kchen6@umbc.edu", [ta_email_address], final_ta.as_string())               
            print(final_ta)
