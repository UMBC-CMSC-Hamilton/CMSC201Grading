    ...
    for index in range(len(base_list)):
        ...
        if(line[0:3] != COMMENT_KEY):
            ...
            if(line[0:3] == SECTION_KEY and in_rubric_section == True):
                ...
                section_score_line = "Section Score: {}/{}".format(section_score * SCALER, section_total * SCALER)
                ...
                if(in_rubric_section):
                    if(line.isspace() == False):
                        ...
                        try:
                            ...
                            line_item_grade = float(line_object[0]) * SCALER
                            line_item_total = float(line_object[1]) * SCALER
